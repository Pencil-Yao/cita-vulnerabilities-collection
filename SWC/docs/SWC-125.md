...
Solidity支持多重继承，这意味着一个合约可以继承多个合约。多重继承引入了称为[Diamond Problem](https://en.wikipedia.org/wiki/Multiple_inheritance#The_diamond_problem)的歧义问题：如果两个或多个基础合约定义了相同的函数，则在子合约中应调用哪个？Solidity通过使用反向[C3线性化](https://en.wikipedia.org/wiki/C3_linearization)来解决这种歧义，该线性化设置了基础合约之间的优先级。
...
- [智能合约最佳实践 - 多重继承警告](https://consensys.github.io/smart-contract-best-practices/development-recommendations/solidity-specific/complex-inheritance/)
- [Solidity文档 - 多重继承和线性化](https://solidity.readthedocs.io/en/v0.4.25/contracts.html#multiple-inheritance-and-linearization)
- [Solidity反模式：轻松理解继承性DAG](https://pdaian.com/blog/solidity-anti-patterns-fun-with-inheritance-dag-abuse)
