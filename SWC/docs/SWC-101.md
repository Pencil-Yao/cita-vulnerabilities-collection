...
当算术运算达到类型的最大或最小值时，将发生上溢/下溢。例如，如果一个数字以 uint8 类型存储， 则意味着该数字以 8 位无符号数字存储，值范围从 0 到 2^8-1。在计算机编程中，当算术运算试图创建 一个超出指定位数表示范围的数值时，就会发生整数溢出。
...
- [以太坊智能合约最佳实践 - 整数溢出](https://consensys.github.io/smart-contract-best-practices/attacks/insecure-arithmetic/)
