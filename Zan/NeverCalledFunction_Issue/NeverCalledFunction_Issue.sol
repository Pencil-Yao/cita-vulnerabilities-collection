...
contract Test2 {
    function bad1(address addr, uint256 amount) public {
        //leak
        address test1Addr = address(new Test1());
        test1Addr.call(abi.encode(bytes4(keccak256("good3(address,uint256)")), addr, amount));
    }
    ...
    function bad3() internal returns (uint) {
        //leak
        return 3;
    }
}
