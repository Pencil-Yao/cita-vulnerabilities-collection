...
contract Test3 {
    ...
    function bad6(address from, address to, uint256 value) external returns (bool) {
        bool isSuccess = bad6_internal(from, to, value);
        return isSuccess;
    }

    function bad6_internal(address _from, address _to, uint256 value) internal returns (bool) {
