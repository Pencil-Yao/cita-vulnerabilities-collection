...
contract Test {
    bytes32 public constant good1 = keccak256(abi.encodePacked("abi", "encode", "packed"));

    function good2(address[3] calldata admins, address[3] calldata regularUsers) external {
