...
contract Test is ReentrancyGuard {
    function bad1(bool success) public nonReentrant returns (bool) {
        //leak
        return success;
    }

    function bad2(bool success) public nonReentrant returns (bool) {
        //leak
        return bad2Func(success);
    }

    function bad2Func(bool success) internal nonReentrant returns (bool) {
        //leak
        return success;
    }
    ...
    function bad3(bool success) private nonReentrant returns (bool) {
        //leak
        return success;
    }
