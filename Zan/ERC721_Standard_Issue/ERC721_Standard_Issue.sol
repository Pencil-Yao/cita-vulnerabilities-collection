...
contract NFToken {
    ...
    event Approval(address indexed _owner, address indexed _approved, uint32 indexed _tokenId); //leak
    event ApprovalForAll(address _owner, address indexed _operator, bool _approved); //leak
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId, uint256 _no) external {
        //leak
        //...
    }
    ...
    function setApprovalForAll(string calldata _operator, bool _approved) external {
        //leak
        //...
    }
    ...
    function isApprovedForAll(address _owner, address _operator) external returns (uint) {
        //leak
        //...
    }
